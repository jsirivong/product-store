...
export default function Product() {
    ...
    const handleDelete = async () => {
        if (window.confirm("Are you sure you want to delete this product?")){
            ...
            navigate("/"); // navigates the user back to the homepage using the navigate object from the useNavigate() hook
        };
    }
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <button className="btn btn-ghost mb-8 text-gray-500" onClick={() => navigate("/")}>
                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={(e) => {
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" placeholder="Enter product name" className="input input-bordered w-full" value={formData.name}
                            ...
                            <div className="form-control">
                                ...
                                <input type="number" min={0} step={0.01} placeholder="0.00" className="input input-bordered w-full" value={formData.price}
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" placeholder={"https://example.com/image.png"} className="input input-bordered w-full" value={formData.image}
